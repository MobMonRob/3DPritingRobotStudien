# Index via upmendex (UTF-8 + ICU); damit werden deutsche Umlaute (Ä, Ö, Ü, ß)
# korrekt sortiert und als eigene Buchstabengruppen ausgegeben.
$makeindex = 'upmendex -s dependencies/style/index.ist -o %D %S';

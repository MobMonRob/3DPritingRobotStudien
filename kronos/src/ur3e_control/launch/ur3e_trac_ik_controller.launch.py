"""
Launch the TRAC-IK based UR3e controller.

Usage (inside the container, with the simulation already running):
  ros2 launch ur3e_control ur3e_trac_ik_controller.launch.py
"""
...
def generate_launch_description():
    ...
    controller_node = Node(
        ...
        executable="ur3e_trac_ik_controller",
        name="ur3e_trac_ik_controller",
        output="screen",
        parameters=[
            robot_description,
            robot_description_semantic,
